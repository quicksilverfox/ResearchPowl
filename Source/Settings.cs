...
namespace ResearchPowl
{
    ...
    {
        public static bool shouldPause, shouldReset, alignToAncestors, searchByDescription, showIndexOnQueue, disableShortcutManual, verboseDebug, swapZoomMode, dontShowUnallowedTech,
            useVanillaResearchFinishedMessage = true, dontIgnoreHiddenPrerequisites = true, alwaysDisplayProgress = true, progressTooltip = true,
            shouldSeparateByTechLevels = true, placeModTechSeparately, placeTabsSeparately = true;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref placeModTechSeparately, "placeModTechsSeparately", false);
